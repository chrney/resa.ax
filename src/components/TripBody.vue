...
<style>
.walk-mode > .q-timeline__subtitle, .walk-mode .q-timeline__title {
  display: none;
}
...
.no-walk-mode > .q-timeline__subtitle { /* Klockslag */
  margin-bottom: 0px
}
...
.no-walk-mode.no-subtitle > .q-timeline__subtitle { /* Klockslag */
  display: none;
}

.no-walk-mode.no-subtitle > .q-timeline__content { /* Klockslag */
  margin-bottom: 20px
}
